...
public class PhotoDownloader {
    ...
    public Observable<Photo> searchForPhotos(List<String> searchQueries){
        ArrayList<Observable<Photo>> photoStreams = new ArrayList<>();
        for (String searchQuery : searchQueries) {
            photoStreams.add(searchForPhotos(searchQuery).subscribeOn(Schedulers.io()));
        }
        return Observable.mergeDelayError(photoStreams);
}
